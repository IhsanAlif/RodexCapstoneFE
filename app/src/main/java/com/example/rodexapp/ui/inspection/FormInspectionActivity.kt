...
import com.example.rodexapp.ui.report.ReportPageActivity
...
class FormInspectionActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            getCurrentLocation { location ->
                ...
                sendInspectionData(locationStart) { success, response ->
                    if (success && response != null) {
                        ...
                        Toast.makeText(this@FormInspectionActivity, "Unexpected error occurred", Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
        ...
        findViewById<Button>(R.id.report_button).setOnClickListener {
            val intent = Intent(this, AboutRoadActivity::class.java)
            ...
            fusedLocationClient.lastLocation.addOnCompleteListener(this, OnCompleteListener { task ->
                if (task.isSuccessful && task.result != null) {
                    ...
                    if (location != null) {
                        ...
                        Toast.makeText(this@FormInspectionActivity, "Unexpected error occurred Location", Toast.LENGTH_SHORT).show()
                    }
                } else {
